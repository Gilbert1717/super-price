...
//         when(this.orderRepository.createOrder(order.capture())).thenReturn(new Order(1L,timestampNow, request.getDeliverTime(),"testing address","Express"));

//         // testing method
//         Order createdOrder = this.orderService.creatingOrder(request);

//         assertEquals(request.getDeliverTime(),order.getValue().getDeliverTime());

//         assertEquals(request.getDeliverTime(), createdOrder.getDeliverTime());
...
//         assertEquals(convertedDeliverTime.toString(),order.getValue().getDeliverTime().toString());
...
//         Order expectedOrder = new Order(1L,timestampNow, deliverTimestamp.toString(),"testing address","Express");
...
//         // mock repository
//         FindOrderResponse orderResponse = new FindOrderResponse(timestampNow, deliverTimestamp.toString(),"Express");
//         Order order = new Order(1L,timestampNow, deliverTimestamp.toString(),"testing address","Express");
